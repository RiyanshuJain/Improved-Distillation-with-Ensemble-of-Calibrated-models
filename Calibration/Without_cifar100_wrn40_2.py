...
# Importing The CIFAR-100 Dataset & Defining Hyperparameters**</font>"""
...
net_simple = wrn_40_2(num_classes = 100)
...
checkpoint = os.path.join('2Aug/checkpoints/wrn40_2/without')
