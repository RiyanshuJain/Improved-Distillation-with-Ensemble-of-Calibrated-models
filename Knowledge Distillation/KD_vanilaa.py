...
model_t = wrn_40_2(num_classes=100)
model1 = torch.load('Weights/without_ckpt-358')
model_t.load_state_dict(model1['state_dict'])
...
checkpoint = os.path.join('checkpoints/KD_vanilaa')
